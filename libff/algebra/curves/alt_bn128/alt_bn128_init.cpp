...
void init_alt_bn128_params()
{
    ...
    alt_bn128_Fr::multiplicative_generator = alt_bn128_Fr("7");
    alt_bn128_Fr::root_of_unity = alt_bn128_Fr("1748695177688661943023146337482803886740723238769601073607632802312037301404");
