...
void init_mcl_bn128_params()
{
    ...
    mcl_bn128_Fr::multiplicative_generator = mcl_bn128_Fr("7");
    mcl_bn128_Fr::root_of_unity = mcl_bn128_Fr("1748695177688661943023146337482803886740723238769601073607632802312037301404");
